...
// This file is a trimmed copy of final_bounds.h.
// It contains only the essential assertion results, and omits the proofs.

#ifndef ESSENTIAL_ASSERTS_FINAL
#define ESSENTIAL_ASSERTS_FINAL  1
...
template <typename T>
void essential_asserts_final(T a, T b, T* pGcd, T* pX, T* pY)
{
